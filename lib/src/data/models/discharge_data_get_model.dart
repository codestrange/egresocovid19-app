...
part 'discharge_data_get_model.g.dart';

@JsonSerializable(explicitToJson: true)
class DischargeDataGetModel {
  const DischargeDataGetModel({
  ...
  static DischargeDataGetModel fromJson(Map<String, dynamic> json) =>
      _$DischargeDataGetModelFromJson(json);

  Map<String, dynamic> toJson() => _$DischargeDataGetModelToJson(this);
}
