...
import 'package:egresocovid19/src/dependencies.dart' as _i34;
import 'package:egresocovid19/src/domain/repositories/repositories.dart'
    as _i11;
import 'package:egresocovid19/src/domain/services/auth_service.dart' as _i33;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i25.PathologyAutocompleteBloc>(
      () => _i25.PathologyAutocompleteBloc(get<String>()));
  ...
  gh.lazySingleton<_i11.IProvinceRepository>(
      () => _i30.ProvinceRepository(get<_i27.ClientApi>()));
  gh.factory<_i31.IProvinceService>(
      () => _i31.ProvinceService(get<_i11.IProvinceRepository>()));
  gh.lazySingleton<_i22.OAuth>(() => registerModule.oauth(
      get<String>(instanceName: 'baseUrl'),
      get<_i6.Dio>(),
      get<_i22.OAuthStorage>()));
  gh.lazySingleton<_i11.IAuthRepository>(
      () => _i32.AuthRepository(get<_i22.OAuth>()));
  gh.lazySingleton<_i33.IAuthService>(
      () => _i33.AuthService(authRepository: get<_i11.IAuthRepository>()));
  return get;
}
