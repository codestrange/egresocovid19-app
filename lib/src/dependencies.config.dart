...
import 'package:egresocovid19/src/data/data_sources/client_api.dart' as _i19;
...
import 'package:egresocovid19/src/data/repositories/theme_repository.dart'
    as _i15;
import 'package:egresocovid19/src/data/utils/hive_oauth_storage.dart' as _i18;
import 'package:egresocovid19/src/dependencies.dart' as _i22;
import 'package:egresocovid19/src/domain/repositories/repositories.dart'
    as _i10;
import 'package:egresocovid19/src/domain/services/auth_service.dart' as _i21;
...
import 'package:egresocovid19/src/domain/services/theme_service.dart' as _i16;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i14.IThemeBloc>(() => _i14.ThemeBloc(get<_i8.IThemeService>()));
  gh.factory<_i10.IThemeRepository>(
      () => _i15.ThemeRepository(get<_i5.Box<int>>(instanceName: 'theme')));
  gh.factory<_i16.IThemeService>(
      () => _i16.ThemeService(get<_i10.IThemeRepository>()));
  gh.lazySingleton<_i17.OAuthStorage>(
      () => _i18.HiveOauthStorage(get<_i5.Box<String>>(instanceName: 'oauth')));
  gh.factory<String>(() => registerModule.baseUrl, instanceName: 'baseUrl');
  gh.lazySingleton<_i19.ClientApi>(() => _i19.ClientApi(get<_i6.Dio>(),
      baseUrl: get<String>(instanceName: 'baseUrl')));
  gh.lazySingleton<_i17.OAuth>(() => registerModule.oauth(
      get<String>(instanceName: 'baseUrl'),
      get<_i6.Dio>(),
      get<_i17.OAuthStorage>()));
  gh.lazySingleton<_i10.IAuthRepository>(
      () => _i20.AuthRepository(get<_i17.OAuth>()));
  gh.lazySingleton<_i21.IAuthService>(
      () => _i21.AuthService(authRepository: get<_i10.IAuthRepository>()));
  return get;
}
