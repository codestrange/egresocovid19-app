...
import 'package:egresocovid19/src/data/data_sources/client_api.dart' as _i26;
...
import 'package:egresocovid19/src/domain/repositories/repositories.dart'
    as _i10;
import 'package:egresocovid19/src/domain/services/auth_service.dart' as _i34;
...
import 'package:egresocovid19/src/domain/services/patient_service.dart' as _i30;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.IPatientCreateBloc>(() => _i15.PatientCreateBloc());
  ...
  gh.factory<_i24.PathologyAutocompleteBloc>(
      () => _i24.PathologyAutocompleteBloc(get<String>()));
  gh.factory<_i25.PathologyBloc>(() => _i25.PathologyBloc());
  gh.factory<String>(() => registerModule.baseUrl, instanceName: 'baseUrl');
  gh.lazySingleton<_i26.ClientApi>(() => _i26.ClientApi(get<_i6.Dio>(),
      baseUrl: get<String>(instanceName: 'baseUrl')));
  gh.lazySingleton<_i10.IAutoCompleteRepository>(
      () => _i27.AutoCompleteRepository(get<_i26.ClientApi>()));
  gh.factory<_i28.IAutoCompleteService>(
      () => _i28.AutoCompleteService(get<_i10.IAutoCompleteRepository>()));
  gh.lazySingleton<_i10.IPatientRepository>(
      () => _i29.PatientRepository(get<_i26.ClientApi>()));
  gh.factory<_i30.IPatientService>(
      () => _i30.PatientService(get<_i10.IPatientRepository>()));
  gh.lazySingleton<_i10.IProvinceRepository>(
      () => _i31.ProvinceRepository(get<_i26.ClientApi>()));
  gh.factory<_i32.IProvinceService>(
      () => _i32.ProvinceService(get<_i10.IProvinceRepository>()));
  gh.lazySingleton<_i21.OAuth>(() => registerModule.oauth(
      get<String>(instanceName: 'baseUrl'),
      get<_i6.Dio>(),
      get<_i21.OAuthStorage>()));
  gh.lazySingleton<_i10.IAuthRepository>(
      () => _i33.AuthRepository(get<_i21.OAuth>()));
  gh.lazySingleton<_i34.IAuthService>(
      () => _i34.AuthService(authRepository: get<_i10.IAuthRepository>()));
  gh.factory<_i35.IHomeBloc>(() => _i35.HomeBloc(get<_i30.IPatientService>()));
  return get;
}
